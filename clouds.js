...
function createCloud() {
    random_x = Math.floor((Math.random() * 200) + 1)
    random_y = Math.floor((Math.random() * 200) + 1)
    random_z = Math.floor((Math.random() * 200) + 1)
    random_a = Math.floor((Math.random() * 200) + 1)
    random_s = Math.floor((Math.random() * 200) + 1)
    var div = document.createElement( 'img'  );
    div.setAttribute('src', 'cloud.png');
